...
export default function ShubhLaxmiListPage() {
  ...
  const fetchRegistrations = useCallback(async () => {
    ...
    try {
      ...
      if (res && res.data) {
        ...
        if (res.summary) {
          setSummary({
            ...
            totalAmount: res.summary.totalAmount || res.data.length * 3100,
          ...
          setSummary({
            ...
            totalAmount: (res.pagination?.total || res.data.length) * 3100,
            totalPaid: totPaid,
      ...
      console.error("Error fetching ShubhLaxmi registrations:", err);
      toast.error(err.message || "शुभलक्ष्मी रिकॉर्ड्स लोड करने में विफल / Failed to load records");
    } finally {
      setIsLoading(false);
    }
  }, [page, searchTerm, selectedGender, selectedCategory, selectedDistrict]);

  useEffect(() => {
    fetchRegistrations();
  }, [fetchRegistrations]);

  const openInstallmentModal = (record: ShubhLaxmiRegistration) => {
  ...
  const handleAddInstallment = async (e: React.FormEvent) => {
    ...
    // Strict enforcement of ₹300 for single ShubhLaxmi ledger
    if (Number(installmentAmount) !== 300) {
      toast.error("शुभलक्ष्मी योजना के लिए किश्त राशि ₹300 निर्धारित है / Installment amount must be exactly ₹300");
      return;
    }
  ...
  const handleDelete = async () => {
    ...
    setIsDeleting(true);
    try {
      await ShubhLaxmiService.deleteRegistration(recordToDelete);
      ...
      <div className="space-y-6 p-4 md:p-6 pb-12 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-border/60 pb-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                <h1 className="text-2xl md:text-3xl font-bold tracking-tight text-foreground">
                  शुभलक्ष्मी योजना पंजीकरण
                </h1>
                <p className="text-sm text-muted-foreground">
                  ShubhLaxmi Registration Application — Fixed Grant ₹3,100 | Pool: UNIFIED_POOL (Male + Female) | Single ₹300 Ledger
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2.5">
            ...
            <Button
              size="sm"
              onClick={() => router.push("/dashboard/shubh-laxmi/add")}
              className="gap-1.5 bg-yellow-600 hover:bg-yellow-700 text-white shadow-sm"
            >
          ...
          <Card className="border-border/60 shadow-sm bg-card hover:shadow-md transition-shadow">
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground mt-1">
                सक्रिय शुभलक्ष्मी आवेदन / Active records
              </p>
            </CardContent>
          </Card>
        ...
        <Card className="border-border/60 shadow-sm">
          <CardContent className="p-4 space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3">
              ...
              {/* Gender Filter (Male + Female both eligible) */}
              <div>
                <select
                ...
                >
                  <option value="ALL">सभी लिंग / All Genders (Male + Female)</option>
            ...
            <div className="flex items-center justify-between">
              <div>
                <CardTitle className="text-base font-semibold">
                  शुभलक्ष्मी पंजीकरण सूची / Registered Applications
                </CardTitle>
              ...
              <div className="flex items-center gap-2">
                <Badge variant="outline" className="text-xs bg-yellow-500/10 text-yellow-700 dark:text-yellow-300 border-yellow-300">
                  Pool: UNIFIED_POOL (M+F)
                </Badge>
                <Badge variant="outline" className="text-xs bg-yellow-500/10 text-yellow-700 dark:text-yellow-300 border-yellow-300">
                  Scheme: SHUBH_LAXMI
                </Badge>
          ...
          <CardContent className="p-0">
            {isLoading ? (
              <div className="min-h-[280px] flex flex-col items-center justify-center gap-2 p-8">
                <RefreshCw className="h-7 w-7 animate-spin text-yellow-600" />
              ...
              <div className="min-h-[280px] flex flex-col items-center justify-center gap-3 p-8 text-center">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-muted-foreground max-w-sm">
                    वर्तमान खोज या फ़िल्टर के साथ कोई शुभलक्ष्मी रिकॉर्ड उपलब्ध नहीं है।
                  </p>
                </div>
                <Button
                  size="sm"
                ...
                <table className="w-full text-left text-sm">
                  <thead className="bg-muted/50 text-xs font-semibold text-muted-foreground uppercase tracking-wider border-b border-border/60">
                    <tr>
                      ...
                      <th className="px-4 py-3">लिंग / Gender</th>
                      ...
                      >
                        ...
                        <td className="px-4 py-3.5 font-mono text-xs font-medium text-foreground whitespace-nowrap">
                          <div className="flex items-center gap-1.5">
                            <span className="text-yellow-600 font-semibold">{reg.formNumber}</span>
                            {reg.epinCode && (
                        ...
                        <td className="px-4 py-3.5 whitespace-nowrap">
                          ...
                          >
                            {reg.gender === "Female" ? "महिला (F)" : "पुरुष (M)"}
                          </Badge>
                        </td>
                        ...
                        {/* Fixed Fee */}
                        <td className="px-4 py-3.5 whitespace-nowrap">
                          <Badge variant="outline" className="font-semibold text-yellow-600 border-yellow-300 bg-yellow-50/30">
                            ₹3,100
                          </Badge>
                        </td>
                        ...
                        <td className="px-4 py-3.5 text-right whitespace-nowrap">
                          <div className="flex items-center justify-end gap-1.5">
                            <Button
                              size="sm"
                              variant="ghost"
                              onClick={() => router.push(`/dashboard/shubh-laxmi/${reg.id}`)}
                            ...
                            <Button
                              ...
                              className="h-8 px-2.5 text-xs gap-1 border-yellow-300 text-yellow-700 hover:bg-yellow-50 dark:border-yellow-800 dark:text-yellow-300"
                            >
          ...
          <DialogContent className="sm:max-w-md">
            <DialogHeader>
              <DialogTitle className="flex items-center gap-2 text-lg">
                ...
                <span>शुभलक्ष्मी किश्त भुगतान दर्ज करें (₹300)</span>
              </DialogTitle>
            ...
            <form onSubmit={handleAddInstallment} className="space-y-4 pt-2">
              ...
              <div className="space-y-1.5">
                <Label htmlFor="shubhInstAmount" className="text-xs font-semibold">
              ...
              {/* Payment Date */}
              <div className="space-y-1.5">
                <Label htmlFor="shubhInstDate" className="text-xs font-semibold">
              ...
              {/* Payment Mode */}
              <div className="space-y-1.5">
                <Label htmlFor="shubhInstMode" className="text-xs font-semibold">
              ...
              <div className="space-y-1.5">
                <Label htmlFor="shubhRashidNo" className="text-xs font-semibold">
              ...
              {/* Note */}
              <div className="space-y-1.5">
                <Label htmlFor="shubhInstNote" className="text-xs font-semibold">
        ...
        <AlertDialog open={isDeleteModalOpen} onOpenChange={setIsDeleteModalOpen}>
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                क्या आप वाकई इस शुभलक्ष्मी पंजीकरण को हटाना चाहते हैं? यह रिकॉर्ड सुरक्षित रूप से सॉफ्ट-डिलीट किया जाएगा।
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
